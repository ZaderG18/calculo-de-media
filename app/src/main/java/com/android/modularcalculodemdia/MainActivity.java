...
public class MainActivity extends AppCompatActivity {
               ...
               boolean retorno = validarCampos();
                if(retorno) {
                    ...
                    if (media >= 6 && nFaltas <= 20) {
                        resultado.setText("O aluno foi aprovado com Média Final: " + media);
                        ...
                        resultado.setText("Aluno REPROVADO por nota Média final " + media);
                        resultado.setTextColor(getColor(R.color.red));
                    }
                }
            }
    ...
    private boolean validarCampos() {
        boolean camposValidados = true;
            ...
            camposValidados = false;
                nota2.setError("Preencha o campo nota 2");
        }
            if(nota3.getText().toString().isEmpty()){
                camposValidados = false;
                nota3.setError("Preencha o campo nota 3");
            }
            if(nota4.getText().toString().isEmpty()){
                    camposValidados = false;
                nota4.setError("Preencha o campo nota 4");
                }
            if(faltas.getText().toString().isEmpty()){
            camposValidados = false;
              faltas.setError("Preencha o campo faltas");
        }
